...
abstract class BaseRemoteService {
	...
	URL buildPath(String ext) {
		return this.buildPath((new PathElementInterface[0]), ext);
	}
	...
	// IF YOU ON CONNECT TO HEROKU
	private static final String BASE_URL = "https://stormy-harbor-55392.herokuapp.com/api/";
