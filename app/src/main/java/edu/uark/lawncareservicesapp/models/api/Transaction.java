...
import edu.uark.lawncareservicesapp.models.api.fields.TransactionFieldName;
...
import edu.uark.lawncareservicesapp.models.api.fields.ProductFieldName;

import static edu.uark.lawncareservicesapp.models.api.enums.TransactionType.SALE;
...
public class Transaction implements ConvertToJsonInterface, LoadFromJsonInterface<Transaction> {
    ...
    public Transaction setClientId(UUID clientId) {
    ...
    public Transaction setRefId(UUID clientId) {
        this.refId = clientId;
        return this;
    }
    ...
    public Transaction loadFromJson(JSONObject rawJsonObject) {
        ...
        String clientId = rawJsonObject.optString(TransactionFieldName.CLIENT_ID.getFieldName());
    ...
    public JSONObject convertToJson() {
        ...
        try {
            ...
            if (this.clientId != null) {
                jsonObject.put(TransactionFieldName.CLIENT_ID.getFieldName(), this.clientId.toString());
            }
